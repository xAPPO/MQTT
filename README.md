...
This version implements the following four key features:
...
Currently the state will not be published until the device state actually changes.. this will be fixed in alpha3
To force an update change the state manually.
...
Maximum Brightness Level is the value of full brightness for this device e.g. 100 255 1.0 a decimal point is significant at it will support real numbers rather than integers.
...
Configure using "HA Statestream topic"
...
Discovered homie switches [10]
Discovered homie dimmers [12]

Discovered HA switches [47]
Discovered HA lights [70]
